...
public class WindowXM extends JFrame {
	...
	private WindowXM(WindowXM parent, LauncherApplet launcher, int menuOptionFlags) {
		...
		preferredWidth = (screenSize.width*4) / 5;
		if (preferredWidth > 1000)
			preferredWidth = 1000;
		preferredHeight = (int)( preferredWidth / 1.628 );
		if (preferredWidth > screenSize.width - 20)
			preferredWidth = screenSize.width - 20;
		if (preferredHeight > screenSize.height - 30)
			preferredHeight = screenSize.height - 30;
